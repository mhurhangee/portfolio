...
export function ContactMe() {
  ...
  return (
    ...
    >
      ...
      <motion.h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-8 font-mono tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-green-400 to-green-600" variants={itemVariants}>
        Contact me
      </motion.h2>
