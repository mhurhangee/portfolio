...
const achievements = [
  { 
    ...
    description: "Over 5 years experience as a UK and European Patent Attorney, specializing in high-tech patents.",
    icon: Briefcase,
  ...
  { 
    ...
    description: "Published 10+ research papers with over 3000 cumulative citations in the field of plastic electronics.",
    icon: Book,
    stat: "3000+ Citations",
    image: "/eureka-ai.png"
  },
  { 
    ...
    description: "Worked on cutting-edge inventions from transistors to autonomous vehicle safety systems and now AI.",
    icon: Cpu,
  ...
  { 
    ...
    description: "Worked with multinational companies and solo entrepreneurs spanning diverse industries and nationalities.",
    icon: Award,
...
export function ExpertiseAndAchievements() {
  return (
    <div className="text-center">
      ...
      >
        From synthesizing plastic electronics to protecting intellectual property, and now driving AI innovation, 
        my journey has been a continuous evolution of turning complex ideas into practical solutions.
      </motion.p>
        ...
        {achievements.map((achievement, index) => (
          ...
          >
            <motion.div variants={contentVariants} className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold text-foreground font-mono tracking-tighter">{achievement.title}</h3>
            </motion.div>
            <motion.p variants={contentVariants} className="text-muted-foreground text-sm mb-4">{achievement.description}</motion.p>
