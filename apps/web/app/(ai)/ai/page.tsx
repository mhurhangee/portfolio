...
import { aiCategories, getAllApps } from "@/lib/ai/playground-config"
              ...
              <Link key={app.href} href={app.href} className="group">
                <Card className="h-full overflow-hidden transition-all duration-300 hover:shadow-xl group-hover:translate-y-[-5px]">
                  ...
                  <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <div className={`p-2 rounded-full bg-gradient-to-br opacity-80 ${app.color} text-primary-foreground transition-all duration-300 group-hover:opacity-100 group-hover:shadow-md`}>
                      {app.icon}
                    </div>
                  </CardHeader>
                  <CardContent>
