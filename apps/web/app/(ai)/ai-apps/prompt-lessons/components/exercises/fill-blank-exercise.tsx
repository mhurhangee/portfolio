...
export default function FillInBlankExerciseComponent({ 
  ...
  const formatSentence = () => {
    return exercise.sentence.replace(/\[BLANK\]/g, 
      feedback ? 
    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="border bg-white dark:bg-slate-900 rounded-lg shadow-sm p-4 mb-3">
        ...
        <div 
          ...
          dangerouslySetInnerHTML={{ __html: formatSentence() }}
        />
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm">
                      ...
                      <span className="text-muted-foreground font-normal"> - {exercise.explanation}</span>
                    </p>
                    {!feedback.isCorrect && (
                      <div className="mt-1 text-xs text-muted-foreground">
                        <p>Correct answer: <span className="font-medium text-foreground">{exercise.correctAnswer}</span></p>
                        <Button
                          variant="ghost"
                          size="sm"
