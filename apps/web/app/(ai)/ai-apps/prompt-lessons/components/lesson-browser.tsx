      ...
      >
        {filteredLessons.map((lesson) => (
          <motion.div key={lesson.id} variants={item}>
            ...
            >
              <div className={`h-2 w-full bg-gradient-to-r ${difficultyColors[lesson.difficulty as keyof typeof difficultyColors]}`} />
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                ...
                <div className={`p-2 rounded-full bg-gradient-to-br opacity-80 ${difficultyColors[lesson.difficulty as keyof typeof difficultyColors]} text-primary-foreground transition-all duration-300 hover:opacity-100 hover:shadow-md`}>
