...
export const lessons: Lesson[] = [
  // ==================== FUNDAMENTALS CATEGORY ====================
  {
    ...
    topic: 'AI Prompts',
    description: 'Learn the essential elements that make up well-crafted AI prompts and how they work together',
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    description: 'Gain insight into how large language models interpret, process, and respond to your prompts',
    difficulty: 'Beginner',
    category: 'Fundamentals',
  },
  {
    ...
    description: 'Understand the relationship between what you input (prompt) and what you receive (completion)',
    difficulty: 'Beginner',
    category: 'Fundamentals',
  },
  {
    ...
    description: 'Break down the structure of prompts and learn how each part contributes to the response',
  ...
  },
  {
    ...
    topic: 'LLM Tokens',
    description: 'Learn how LLMs tokenize text and why token management is crucial for effective prompting',
    difficulty: 'Intermediate',
    category: 'Fundamentals',
  },
  {
    ...
    description: 'Explore what different LLMs can and cannot do, and how to work within their constraints',
    difficulty: 'Advanced',
    category: 'Fundamentals',
  },
  ...
  },
  {
    ...
    description: 'Identify and eliminate sources of confusion in your prompts to get more reliable results',
    difficulty: 'Beginner',
    category: 'Clarity',
  },
  {
  ...
  },
  {
    ...
    description: 'Develop skills in selecting exact words and phrases for maximum prompt effectiveness',
    difficulty: 'Advanced',
    category: 'Clarity',
  },
  ...
  // ==================== SPECIFICITY CATEGORY ====================
  {
    ...
    topic: 'Prompt Detail',
    description: 'Learn how adding appropriate details to your prompts leads to more accurate AI responses',
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    topic: 'Scope Setting',
    description: 'Master the technique of setting boundaries for AI responses through careful prompt construction',
    difficulty: 'Intermediate',
    category: 'Specificity',
  },
  {
  ...
  },
  {
    ...
    description: 'Develop techniques for specifying style, tone, complexity, and other qualitative aspects',
    difficulty: 'Advanced',
    category: 'Specificity',
  },
  ...
  // ==================== STRUCTURE CATEGORY ====================
  {
    ...
    topic: 'Format Basics',
    description: 'Learn how to structure your prompts for improved readability and processing by AI',
    difficulty: 'Beginner',
    category: 'Structure',
  },
  {
    ...
    description: 'Master the art of breaking down complex requests into structured multi-part prompts',
    difficulty: 'Intermediate',
    category: 'Structure',
  },
  {
    ...
    description: 'Learn to create prompts with clear hierarchies that guide AI to process information in a specific order',
    difficulty: 'Intermediate',
    category: 'Structure',
  },
  {
    ...
    topic: 'Prompt Logic',
    description: 'Explore how to incorporate if-then structures and logical conditions in your prompts',
    difficulty: 'Advanced',
    category: 'Structure',
  },
  {
    ...
    description: 'Study effective syntactical structures that enhance AI understanding and response quality',
    difficulty: 'Advanced',
    category: 'Structure',
  },
  ...
  // ==================== CONTEXT CATEGORY ====================
  {
    ...
    description: 'Understand why providing appropriate context is critical for getting relevant AI responses',
    difficulty: 'Beginner',
    category: 'Context',
  },
  {
    ...
    description: 'Learn techniques for including relevant background information to improve AI responses',
    difficulty: 'Beginner',
    category: 'Context',
  },
  {
  ...
  },
  {
    ...
    description: 'Develop strategies for effective prompting within the constraints of AI context windows',
    difficulty: 'Intermediate',
    category: 'Context',
  },
  {
    ...
    description: 'Learn sophisticated methods to maintain context across multiple exchanges with AI',
    difficulty: 'Advanced',
    category: 'Context',
  },
  ...
  // ==================== TECHNIQUES CATEGORY ====================
  {
    ...
    description: 'Learn how to guide AI behavior by providing a few examples of desired inputs and outputs',
    difficulty: 'Beginner',
    category: 'Techniques',
  },
  {
  ...
  },
  {
    ...
    topic: 'AI Persona',
    description: 'Explore how assigning roles or personas to AI can enhance response quality and relevance',
    difficulty: 'Intermediate',
    category: 'Techniques',
  },
  {
  ...
  },
  {
    ...
    description: 'Develop techniques for prompting AI to verify its own outputs and maintain consistency',
    difficulty: 'Advanced',
    category: 'Techniques',
  },
  {
    ...
    description: 'Master the advanced technique of exploring multiple reasoning paths for complex problems',
    difficulty: 'Advanced',
    category: 'Techniques',
  },
  {
  ...
  // ==================== FRAMEWORKS CATEGORY ====================
  {
    ...
    description: 'Learn the basic principles and methodologies behind systematic prompt engineering',
    difficulty: 'Beginner',
    category: 'Frameworks',
  },
  {
    ...
    description: 'Master a structured approach to designing prompts based on specific task requirements',
    difficulty: 'Intermediate',
    category: 'Frameworks',
  },
  {
    ...
    topic: 'CRISPE Method',
    description: 'Learn to apply the Capacity, Role, Insight, Statement, Personality, Experiment framework',
    difficulty: 'Intermediate',
    category: 'Frameworks',
  },
  {
  ...
  },
  {
    ...
    description: 'Explore techniques for eliciting creative, engaging narratives and content from AI',
    difficulty: 'Intermediate',
    category: 'Use Cases',
  },
  {
    ...
    description: 'Learn how to craft prompts that help with literature reviews, hypothesis generation, and research planning',
    difficulty: 'Advanced',
    category: 'Use Cases',
  },
  {
    ...
    description: 'Master advanced techniques for prompting AI systems that work with both text and images',
    difficulty: 'Advanced',
    category: 'Use Cases',
  },
  ...
  // ==================== ETHICS CATEGORY ====================
  {
    ...
    topic: 'Prompt Ethics',
    description: 'Understand the ethical implications of different prompting strategies and content',
    difficulty: 'Beginner',
    category: 'Ethics',
  },
  {
    ...
    description: 'Learn techniques to recognize and reduce potential biases in your prompts and AI responses',
    difficulty: 'Intermediate',
    category: 'Ethics',
  },
  {
    ...
    description: 'Develop strategies for encouraging factual accuracy and truthfulness in AI outputs',
    difficulty: 'Intermediate',
    category: 'Ethics',
  },
  {
  ...
  },
  {
    ...
    description: 'Learn how to quantitatively measure and compare the effectiveness of different prompts',
    difficulty: 'Intermediate',
    category: 'Evaluation',
  },
  {
    ...
    description: 'Master techniques for maintaining prompt versions and conducting comparative tests',
    difficulty: 'Advanced',
    category: 'Evaluation',
  },
  {
    ...
    description: 'Explore sophisticated techniques for fine-tuning prompts to maximize effectiveness',
    difficulty: 'Advanced',
    category: 'Evaluation',
  },
];
