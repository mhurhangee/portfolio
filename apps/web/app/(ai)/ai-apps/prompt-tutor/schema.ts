...
export const tutorResponseSchema = z.object({
  ...
  explanation: z.string().describe("Detailed explanation of the prompt's effectiveness and suggestions for improvement"),
  examples: z.object({
  ...
  principles: z.array(z.string().describe("Relevant prompt engineering principles that apply to this case")),
  nextLessonSuggestion: z.string().describe("Suggestion for what the user should focus on learning next to improve their prompting skills")
});
