...
import { CardContent, CardFooter, Card, CardHeader, CardTitle, CardDescription } from "@workspace/ui/components/card"
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {isLoading ? (
              ...
              <div className="text-center text-muted-foreground">
                <p>No recipe suggestions found. Try adding more ingredients or changing the mode.</p>
              </div>
            ) : (
              <div className="space-y-4">
