            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="strict" className="font-normal">Strict Mode (only use listed ingredients)</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="flexible" id="flexible" />
                  <Label htmlFor="flexible" className="font-normal">Flexible Mode (may suggest 1-2 additional items)</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="staples" id="staples" />
                  <Label htmlFor="staples" className="font-normal">Assume Pantry Staples (salt, pepper, oil, etc.)</Label>
                </div>
              </RadioGroup>
            </div>
          </div>
