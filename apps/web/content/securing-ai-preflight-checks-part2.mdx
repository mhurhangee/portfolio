...
tags: ['ai-moderation', 'user-experience', 'llm', 'preflight-checks', 'ai-ethics', 'business-strategy']
...
const errorDisplayMap = {
  'blacklisted_keywords': (result) => ({
    ...
    description: 'Your message contains terms that aren\'t allowed. Please revise your message and try again.',
    action: {
      label: 'Learn More',
